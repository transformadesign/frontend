...
const Page: React.FC<Props> = ({ className, page }) => {
    ...
    return (
        <Container className="py-9 sm:py-16">
            <Heading level="4" className="uppercase mb-6">{RichText.asText(page.foreignTitle)}</Heading>
            <Heading level="2" className="mb-6">{RichText.asText(page.mainTitle)}</Heading>
